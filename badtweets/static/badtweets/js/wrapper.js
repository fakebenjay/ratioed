function tweetCall(paramsObj, callback) {
	if (!!paramsObj.date) {
		var url = `https://ratioed2.herokuapp.com/badtweets/?date=${paramsObj.date}&username=${paramsObj.name}`
	} else {
		var url = `https://ratioed2.herokuapp.com/badtweets/?username=${paramsObj.name}`
	}
